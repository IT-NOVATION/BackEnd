...
public class MovieController {
    ...
    private final MovieCrawlService movieCrawlService; // autowired 해서 생성하지 않고 new 로 생성하면 @Value 어노테이션이 작동이 되지 않는다.
    ...
    public String getMovieName(Model model) {
        ...
        Map<String, String> movieAndPoster = movieCrawlService.getMovieAndPoster();
