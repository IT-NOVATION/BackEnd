...
public class MovieLogReviewInfoDto {
    ...
    @Builder
    public MovieLogReviewInfoDto(Long reviewId, String reviewTitle, Float star, String reviewMainText, String createdDate, int likeCount, int comments, MovieLogMovieofReviewsInfoDto movieLogMovieofReviewsInfoDtoList) {
