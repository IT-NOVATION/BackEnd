...
public class SaveTest {
    ...
    public void 같은_트랜잭션에서_같은객체인지(){
        ...
        movieInfo.put("helloworld", originMovie);
        repoService.saveMovie(movieInfo);
        Optional<Movie> helloworld = repoService.findByTitle("helloworld");
    ...
    public void 기존db에서불러왔을때_equal하게보는지(){
        ...
        Assertions.assertThat(originMovie).isNotEqualTo(findMovie);
